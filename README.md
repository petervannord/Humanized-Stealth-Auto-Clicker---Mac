...
## Easy Usage Instructions 
  1: go to releases, download the terminal app and then run it.
...
3. Open the downloaded folder and run the requirements file, then the main Python file (main.py).
